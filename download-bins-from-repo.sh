...
dir=/illumio-repo/21.5.35/
mkdir --parents $dir
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-releases/21.5/GA%20Releases/21.5.35/pce/pkgs/illumio-pce-21.5.35-9.c8.x86_64.rpm
echo -n "."
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-releases/21.5/GA%20Releases/21.5.35/pce/pkgs/UI/illumio-pce-ui-21.5.35.UI1-1.x86_64.rpm
echo -n "."
...
echo -n "."
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-releases/21.5/GA%20Releases/21.5.35/compatibility/illumio-release-compatibility-34-254.tar.bz2
echo -n "."
...
dir=/illumio-repo/22.5.10/
mkdir --parents $dir
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-releases/22.5/GA%20Releases/22.5.10/pce/pkgs/illumio-pce-22.5.10-95.c8.x86_64.rpm
echo -n "."
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-releases/22.5/GA%20Releases/22.5.10/pce/pkgs/UI/illumio-pce-ui-22.5.10.UI1-113.x86_64.rpm
echo -n "."
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-releases/19.3/GA%20Releases/19.3.8/ven/bundle/illumio-ven-bundle-19.3.8-6520.tar.bz2
echo -n "."
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-releases/22.5/GA%20Releases/22.5.10/compatibility/illumio-release-compatibility-33-247.tar.bz2
echo -n "."

#bin cleanup
versions="19.3.6 21.5.35 22.2.40 22.5.10"

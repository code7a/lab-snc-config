...
mkdir --parents $dir
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-staging/22.5/GA%20Releases/22.5.0.RC2/pce/pkgs/illumio-pce-22.5.0-1002.c8.x86_64.rpm
echo -n "."
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-staging/22.5/GA%20Releases/22.5.0.RC2/pce/pkgs/UI/illumio-pce-ui-22.5.0.UI1-1149.x86_64.rpm
echo -n "."
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-staging/22.5/GA%20Releases/22.5.0.RC2/ven/bundle/illumio-ven-bundle-22.5.0-9615.tar.bz2
echo -n "."
wget --quiet --timestamping --directory-prefix $dir $REPO/illumio-releases/22.2/GA%20Releases/22.2.30/compatibility/illumio-release-compatibility-25-219.tar.bz2
echo -n "."
